/**
 * Donn├®es de d├®monstration pour peupler le site au premier lancement.
 */
...
export const defaultSiteConfig: SiteConfig = {
  ...
  tagline: 'Cr├®atrice de bijoux fantaisies & co ÔÇö Pi├¿ces uniques faites main',
  ...
  adresse: '',
  metaTitle: 'Perlipimpon ÔÇö Cr├®atrice de bijoux fantaisies, ├®nergies et pierres naturelles',
  metaDescription: 'Perlipimpon vous propose des bijoux artisanaux faits main, inspir├®s par la lune et les ├®nergies. Cr├®ations uniques en pierres naturelles.',
  categories: [
    { name: 'Colliers', description: 'Colliers en pierres naturelles' },
    { name: 'Bracelets', description: 'Bracelets ├®nerg├®tiques' },
    ...
    { name: 'Ensembles', description: 'Parures compl├¿tes' }
  ],
  stones: [
    'Pierre de lune', 'Perle', 'Am├®thyste', 'Quartz rose',
  ...
  stonesData: [],
  aboutTitle: 'Fait main, fait avec c┼ôur',
  aboutText1: 'Bienvenue chez Perlipimpon ! Chaque bijou est une cr├®ation unique, fa├ºonn├®e ├á la main avec patience et passion.',
  aboutText2: 'Que ce soit pour vous faire plaisir ou pour offrir, nos bijoux fantaisies apportent une touche d\'├®l├®gance naturelle ├á chaque tenue.',
  aboutImage: '/images/moonstone_necklace.png',
  heroSubtitle: 'Ô£ª bijoux artisanaux Ô£ª',
  heroTitle1: 'L\'art de la ',
  heroTitle2: 'cr├®ation',
  heroDescription: 'Des bijoux fantaisies uniques, fabriqu├®s ├á la main avec des pierres naturelles soigneusement s├®lectionn├®es.',
  heroImage: '/images/hero_bg.png',
  ctaTitle: 'Une pi├¿ce vous fait envie ?',
  ctaDescription: 'Contactez-nous pour toute question ou commande personnalis├®e.',
  testimonials: [],
  processSteps: []
};
...
},
{
  ...
  "description": "Boucles doreilles fleuries dÔÇÖinspiration cosmique, avec un petit detail vert emeraude.",
  "prix": 35,
  "categorie": "Boucles d'oreilles",
  "pierres": [],
  "photos": [
...
{
  "id": "demo-001",
  "titre": "Collier ├ëclat de Lune",
  "description": "Un collier d├®licat en argent 925 serti d'une pierre de lune aux reflets bleut├®s. Pi├¿ce unique fabriqu├®e enti├¿rement ├á la main.",
  "prix": 89,
  "categorie": "Colliers",
  "pierres": [
    "Pierre de lune"
